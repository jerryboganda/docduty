...
class FacilityProfileController extends GetxController {
  ...
  void onMenuTap(int index, BuildContext context) {
    switch (index) {
      case 0:
        Get.toNamed(Routes.FACILITY_PROFILE);
        break;
      case 1:
        Get.toNamed(Routes.FACILITY_LOCATIONS);
        break;
      case 2:
        Get.toNamed(Routes.FACILITY_WALLET);
        break;
      case 3:
